    ...
    if len(args) >= 1:
        ...
        if val in ["off", "no", "0"]:
            ...
            if amount <= 0:
                ...
                message.reply_text(
                    "Antiflood has been updated and set to {}".format(amount)
                )
                return (
                    "<b>{}:</b>"
                    "\n#SETFLOOD"
...
def flood(bot: Bot, update: Update):
    ...
    if limit == 0:
        ...
        update.effective_message.reply_text(
            "I'm currently banning users if they send more than {} consecutive messages.".format(
                limit
            )
        )
